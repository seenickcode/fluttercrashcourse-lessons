...
// WARNING you must re-run `flutter pub run build_runner build` when updating this file!
...
class Calendar {
  ...
  // needs to be optional because when we save this, includeIfNull must allow this
  // field to be omitted
  // TODO don't make optional and figure out how to save it along with dates (if they exist)
